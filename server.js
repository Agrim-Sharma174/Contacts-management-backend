...
app.use(express.json()); // -a middleware- when we accept a data from client to server, we have to use a middleware. if we don't use this line, the console.log("...", req.bdy) will show req.body as undefined(when we use the body tab of thunderclient, to enter the data)- while creating contact
